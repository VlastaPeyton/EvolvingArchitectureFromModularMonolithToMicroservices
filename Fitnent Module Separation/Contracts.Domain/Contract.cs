...
namespace Contracts.Domain
{
    public sealed class Contract
    {
        ...
        public bool IsSigned => SignedAt.HasValue; // Moze HasValue, jer SignetAt ima ? 
        ...
        public static Contract Prepare(Guid customerId, int customerAge, int customerHeight, DateTimeOffset preparedAt, bool? isPreviousContractSigned = null)
        {
            ...
            BusinessRuleValidator.Validate(new CustomerMustBeSmallerThanMaximumHeightRule(customerHeight));
