...
namespace Contracts.Domain.SignContract.BusinessRules
{
    internal sealed class ContractCanOnlyBeSignedWithin30DaysFromPreparation : IBusinessRule
    {
        ...
        internal ContractCanOnlyBeSignedWithin30DaysFromPreparation(DateTimeOffset preparedAt, DateTimeOffset signedAt)
        {
        ...
        public string Error => "Contract can not be signed because more than 30 days have passed from the contract preparation";
    }
}
